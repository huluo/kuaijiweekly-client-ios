...
#import "HLPracticeDataViewController.h"

@interface HLPracticeDataViewController ()<UITableViewDelegate,UITableViewDataSource>
{
        NSArray *_arrayList;
}
@end

@implementation HLPracticeDataViewController
