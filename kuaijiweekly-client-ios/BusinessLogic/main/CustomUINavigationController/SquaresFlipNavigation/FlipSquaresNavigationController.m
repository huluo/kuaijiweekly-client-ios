...
#warning mark - 设置方向
    ...
    for (int col=SQUARE_COLUMNS-1; col>=0; col--) {
        for (int row=SQUARE_ROWS-1; row>=0; row--) {
    ...
    for (NSNumber *currentPos in orderArray) {
        ...
        [self performBlock:^{
            ...
            CAGradientLayer *fromGradient = [fromViewCrop addLinearGradientWithColor:[UIColor whiteColor] transparentToOpaque:YES];
            CAGradientLayer *toGradient = [fromViewCrop addLinearGradientWithColor:[UIColor whiteColor] transparentToOpaque:YES];
